...
{
    if (tn < 31) {
        buf[0] = (static_cast<uint8_t>(tc) << 6) | (static_cast<uint8_t>(pc) << 5) | static_cast<uint8_t>(tn);

        return 1;
    } else {
        buf[0] = (static_cast<uint8_t>(tc) << 6) | (static_cast<uint8_t>(pc) << 5) | static_cast<uint8_t>(0x1f);
    ...
    uint64_t& offset)
{
    ...
    case 0x02:
        if (len >= 5) {
            n = (static_cast<uint64_t>(b[1]) << 16) | (static_cast<uint64_t>(b[2]) << 8) | static_cast<uint64_t>(b[3]);
    ...
    default:
        ...
        if ((l > 0) && (l <= 8) && (2 + l + 1 <= len)) {
            ...
            case 1:
                ...
                break;
            case 2:
                n = (static_cast<uint64_t>(b[2]) << 8) | static_cast<uint64_t>(b[3]);

                break;
            case 3:
                n = (static_cast<uint64_t>(b[2]) << 16) | (static_cast<uint64_t>(b[3]) << 8) | static_cast<uint64_t>(b[4]);

                break;
            case 4:
                n = (static_cast<uint64_t>(b[2]) << 24) | (static_cast<uint64_t>(b[3]) << 16) | (static_cast<uint64_t>(b[4]) << 8) | static_cast<uint64_t>(b[5]);

                break;
            case 5:
                n = (static_cast<uint64_t>(b[2]) << 32) | (static_cast<uint64_t>(b[3]) << 24) | (static_cast<uint64_t>(b[4]) << 16) | (static_cast<uint64_t>(b[5]) << 8) | static_cast<uint64_t>(b[6]);

                break;
            case 6:
                n = (static_cast<uint64_t>(b[2]) << 40) | (static_cast<uint64_t>(b[3]) << 32) | (static_cast<uint64_t>(b[4]) << 24) | (static_cast<uint64_t>(b[5]) << 16) | (static_cast<uint64_t>(b[6]) << 8) | static_cast<uint64_t>(b[7]);

                break;
            case 7:
                n = (static_cast<uint64_t>(b[2]) << 48) | (static_cast<uint64_t>(b[3]) << 40) | (static_cast<uint64_t>(b[4]) << 32) | (static_cast<uint64_t>(b[5]) << 24) | (static_cast<uint64_t>(b[6]) << 16) | (static_cast<uint64_t>(b[7]) << 8) | static_cast<uint64_t>(b[8]);

                break;
            default:
                n = (static_cast<uint64_t>(b[2]) << 56) | (static_cast<uint64_t>(b[3]) << 48) | (static_cast<uint64_t>(b[4]) << 40) | (static_cast<uint64_t>(b[5]) << 32) | (static_cast<uint64_t>(b[6]) << 24) | (static_cast<uint64_t>(b[7]) << 16) | (static_cast<uint64_t>(b[8]) << 8) | static_cast<uint64_t>(b[9]);
            }
    ...
    uint64_t& significand)
{
    ...
    case 2:
        ...
        break;
    case 3:
        n = (static_cast<uint64_t>(b[0]) << 16) | (static_cast<uint64_t>(b[1]) << 8) | static_cast<uint64_t>(b[2]);

        break;
    case 4:
        n = (static_cast<uint64_t>(b[0]) << 24) | (static_cast<uint64_t>(b[1]) << 16) | (static_cast<uint64_t>(b[2]) << 8) | static_cast<uint64_t>(b[3]);

        break;
    case 5:
        n = (static_cast<uint64_t>(b[0]) << 32) | (static_cast<uint64_t>(b[1]) << 24) | (static_cast<uint64_t>(b[2]) << 16) | (static_cast<uint64_t>(b[3]) << 8) | static_cast<uint64_t>(b[4]);

        break;
    case 6:
        n = (static_cast<uint64_t>(b[0]) << 40) | (static_cast<uint64_t>(b[1]) << 32) | (static_cast<uint64_t>(b[2]) << 24) | (static_cast<uint64_t>(b[3]) << 16) | (static_cast<uint64_t>(b[4]) << 8) | static_cast<uint64_t>(b[5]);

        break;
    case 7:
        n = (static_cast<uint64_t>(b[0]) << 48) | (static_cast<uint64_t>(b[1]) << 40) | (static_cast<uint64_t>(b[2]) << 32) | (static_cast<uint64_t>(b[3]) << 24) | (static_cast<uint64_t>(b[4]) << 16) | (static_cast<uint64_t>(b[5]) << 8) | static_cast<uint64_t>(b[6]);

        break;
    case 8:
        n = (static_cast<uint64_t>(b[0]) << 56) | (static_cast<uint64_t>(b[1]) << 48) | (static_cast<uint64_t>(b[2]) << 40) | (static_cast<uint64_t>(b[3]) << 32) | (static_cast<uint64_t>(b[4]) << 24) | (static_cast<uint64_t>(b[5]) << 16) | (static_cast<uint64_t>(b[6]) << 8) | static_cast<uint64_t>(b[7]);
...
bool asn1::ber::decode_utc_time(const void* buf, uint64_t len, time_t& t)
{
    ...
    if ((IS_DIGIT(b[0])) && (IS_DIGIT(b[1])) && (IS_DIGIT(b[2])) && (IS_DIGIT(b[3])) && (IS_DIGIT(b[4])) && (IS_DIGIT(b[5])) && (IS_DIGIT(b[6])) && (IS_DIGIT(b[7])) && (IS_DIGIT(b[8])) && (IS_DIGIT(b[9]))) {
        struct tm tm;
            ...
            if ((tm.tm_mday >= 1) && (tm.tm_mday <= 31)) {
                ...
                if (tm.tm_hour <= 23) {
                    ...
                    if (tm.tm_min <= 59) {
                        ...
                        if (off + 4 == len) {
                            if ((IS_DIGIT(b[off])) && (IS_DIGIT(b[off + 1])) && (IS_DIGIT(b[off + 2])) && (IS_DIGIT(b[off + 3]))) {
    ...
    struct timeval& tv)
{
    ...
    if ((len >= 10) && (IS_DIGIT(b[0])) && (IS_DIGIT(b[1])) && (IS_DIGIT(b[2])) && (IS_DIGIT(b[3])) && (IS_DIGIT(b[4])) && (IS_DIGIT(b[5])) && (IS_DIGIT(b[6])) && (IS_DIGIT(b[7])) && (IS_DIGIT(b[8])) && (IS_DIGIT(b[9]))) {
        struct tm tm;
        tm.tm_year = ((b[0] - '0') * 1000) + ((b[1] - '0') * 100) + ((b[2] - '0') * 10) + (b[3] - '0');
                ...
                if ((tm.tm_mday >= 1) && (tm.tm_mday <= 31)) {
                    ...
                    if (tm.tm_hour <= 23) {
                        ...
                        if (len >= 12) {
                                    ...
                                    if (len >= 14) {
                                                ...
                                                if (len >= 16) {
                                                    ...
                                                    case ',': {
                                                        ...
                                                        if (decode_time_fraction(b,
                                                                ...
                                                                fraction,
                                                                total)) {
                                                            tv.tv_usec = fraction * (1000000ull / total);
                                                        } else {
                                                            return false;
                                                        }
                                                    }
                                        ...
                                        case ',': {
                                            ...
                                            if (decode_time_fraction(b,
                                                    ...
                                                    fraction,
                                                    total)) {
                                                uint64_t microseconds = fraction * (60000000ull / total);
                            ...
                            case ',': {
                                ...
                                if (decode_time_fraction(b,
                                        ...
                                        fraction,
                                        total)) {
                                    uint64_t microseconds = fraction * (3600000000ull / total);
                        ...
                        if (off + 1 == len) {
                            ...
                            if (((b[off] == '+') || (b[off] == '-')) && (IS_DIGIT(b[off + 1])) && (IS_DIGIT(b[off + 2]))) {
                            ...
                            if (((b[off] == '+') || (b[off] == '-')) && (IS_DIGIT(b[off + 1])) && (IS_DIGIT(b[off + 2])) && (IS_DIGIT(b[off + 3])) && (IS_DIGIT(b[off + 4]))) {
                                unsigned hour = ((b[off + 1] - '0') * 10) + (b[off + 2] - '0');
